        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#5B3DC8]/20 transition-colors">
            ...
            <p className="text-gray-400">
              Email: <a href="mailto:info@thes.space" className="hover:text-white">info@thes.space</a>
            </p>
          </div>
        </div>
        
        <div className="border-t border-white/10 pt-8 text-gray-400 text-sm flex flex-col md:flex-row justify-between">
          <p>&copy; {new Date().getFullYear()} TheS. All rights reserved.</p>
